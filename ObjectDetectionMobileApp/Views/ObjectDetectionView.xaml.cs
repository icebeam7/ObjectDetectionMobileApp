...
using ObjectDetectionMobileApp.ViewModels;
using System.Linq;

namespace ObjectDetectionMobileApp.Views
{
    public partial class ObjectDetectionView : ContentPage
    {
        ...
        public ObjectDetectionView()
        {
            ...
            var vm = (ObjectDetectionViewModel)BindingContext;
            vm.PropertyChanged += (s, e) =>
            {
                if (e.PropertyName == nameof(ObjectDetectionViewModel.Image) || e.PropertyName == nameof(vm.Predictions))
                {
        ...
        static void DrawPredictions(ObjectDetectionViewModel vm, SKCanvas canvas, float left, float top, float scaleWidth, float scaleHeight)
        {
